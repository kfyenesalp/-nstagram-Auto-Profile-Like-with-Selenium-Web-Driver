...
LoginUsername = "dogrulamakoduu29"
...
time.sleep(5)
input_alanı = browser.find_element_by_xpath("/html/body/div[1]/section/nav/div[2]/div/div/div[2]/input")

#Enter the username of the person whose photos you want to like here.
input_alanı.send_keys("oneposter.ua")
time.sleep(4)
